      ...
      <div class="row">
        <div class="col-sm-6 login-section-wrapper">
          ...
          <div class="login-wrapper my-auto">
            ...
            <p class="login-wrapper-footer-text">¿Ya Tiene Cuenta? <a href="../log/index.php" class="text-reset">¡Presione aqui!</a></p>
          </div>
          
        </div>
        <div class="col-sm-6 px-0 d-none d-sm-block">
          <img src="../assets/img/reg.jpg" alt="reg image" class="reg-img">
        </div>
      </div>
    </div>
  </main>
